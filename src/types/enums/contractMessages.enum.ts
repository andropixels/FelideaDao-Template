export enum CONTRACT_MESSAGES {
  ...
  ADD_STAKE = 'addStake',
  ADD_STAKE_FOR_OWNER = 'addStakeForOwner',
  REDEEM_STAKE = 'redeemStake',
  REDEEM_DAO_STAKE = 'redeemDaoStake',
  ...
  SET_CONFIDENCE = 'setTheConfidence',
  EFFICIENCY_PERCENT = 'efficiencyPercent',
  ADD_STAKE_FOR_DAO = 'addStakeForDao',
  GET_DAO_LIST = 'getDaoList',
  CHANGE_DAO_ADMIN = 'changeDaoAdmin',
  GET_STAKED_DAO_LIST = 'getStakedDaoList',
  GET_DAO_OWNERSHIP = 'getDaoOwnership',
  GET_MEMBER_EFFICIENCY = 'efficiencyPercent',
  SET_DAO_ID = 'setDaoId',
}
